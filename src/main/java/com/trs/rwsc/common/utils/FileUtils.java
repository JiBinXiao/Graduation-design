...
public class FileUtils extends org.apache.commons.io.FileUtils {
	...
	/*suffix 整个文件name  
	  return 上传文件后缀名 */
	public static String getEXT(String suffix){
		if (suffix !=null && suffix.length()>0) {
			suffix =suffix.substring(suffix.indexOf(".")+1, suffix.length()).trim();
		}
		if("jpg".equalsIgnoreCase(suffix)||"jpeg".equalsIgnoreCase(suffix)||"png".equalsIgnoreCase(suffix)||"gif".equalsIgnoreCase(suffix)||"bmp".equalsIgnoreCase(suffix)){
				return "img";
		}else if("txt".equalsIgnoreCase(suffix)||"doc".equalsIgnoreCase(suffix)||"docx".equalsIgnoreCase(suffix)||"xls".equalsIgnoreCase(suffix)||"xlsx".equalsIgnoreCase(suffix)||"pdf".equalsIgnoreCase(suffix)){
			return "file";
		}
		return "";
	}
