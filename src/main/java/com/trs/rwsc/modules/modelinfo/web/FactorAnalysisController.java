 ...
 */
@Controller
@RequestMapping(value = "${adminPath}/factor/")
public class FactorAnalysisController extends BaseController {
    ...
    public String list(Modelinfo modelinfo, HttpServletRequest request, HttpServletResponse response, Model model) {
        ...
        modelinfo.setModeltype(ModelConstant.TYPE_FACTOR);
