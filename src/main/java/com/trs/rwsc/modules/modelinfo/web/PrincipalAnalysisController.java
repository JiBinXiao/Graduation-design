 ...
 */
@Controller
@RequestMapping(value = "${adminPath}/principal/")
public class PrincipalAnalysisController extends BaseController {
    ...
    public String list(Modelinfo modelinfo, HttpServletRequest request, HttpServletResponse response, Model model) {
        ...
        modelinfo.setModeltype(ModelConstant.TYPE_PRINCIPAL);
    ...
    public String calculate(Modelinfo modelinfo) {
        ...
        return RtnResult.successInfo("正在计算……", null);
    }

    @RequestMapping(value = "view")
    public String view(Modelinfo modelinfo, Model model) {
        if (modelinfo != null) {
            ...
            for(Map.Entry<String, Object> entry : map.entrySet()) {
                if (entry.getKey().contains("cov")) {

                }
            }
            model.addAttribute("map", map);
        }
        return "modules/principal/view";
    }
}
