 ...
 */
@Controller
@RequestMapping(value = "${adminPath}/ahp/")
public class HirearchyAnalysisController extends BaseController {
    ...
    public String list(Modelinfo modelinfo, HttpServletRequest request, HttpServletResponse response, Model model) {
        modelinfo.setModeltype(ModelConstant.TYPE_HIREARCHY);
