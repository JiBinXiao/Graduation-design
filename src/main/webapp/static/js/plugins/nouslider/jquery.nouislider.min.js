...
(function(b) {
	...
	function n(a) {
		...
		b(q).each(function(b, l) {
			if(void 0 === a[l]) e[l] = u[b];
			else if(typeof a[l] === typeof u[b]) {
	...
	function g(a, e) {
		...
		return new g.prototype.p(a.target || function() {}, a.method, a.format || {}, e)
	}
	var q = "decimals mark thousand prefix postfix encoder decoder negative negativeBefore to from".split(" "),
		u = [2, ".", "", "", "", function(a) {
			return a
		}, function(a) {
			return a
	...
	g.prototype.p = function(a, e, d, g) {
		...
		this.update = !g;
		if("string" ===
			typeof a && 0 === a.indexOf("-tooltip-")) this.K(a, e);
	...
	g.prototype.write = function(a, b, d, g) {
		if(!this.update || !1 !== g)
			if(this.u = a, this.F = a =
				this.format(a), "function" === typeof this.method) this.method.call(this.target[0] || d[0], a, b, d);
			else this.target[this.method](a, b, d)
	};
...
(function(b) {
	...
	function B(a, c) {
		if("lower" === c && 1 === a.b) a.i = 1;
		else if("upper" === c && 1 === a.b) a.i = 2;
		else if(!0 === c && 2 === a.b) a.i = 3;
		else if(!1 === c) a.i = 0;
	...
	function N(a, c) {
		var d = b("<div><div/></div>").addClass(k[2]),
			f = ["-lower", "-upper"];
		a.dir && f.reverse();
	...
	function T(d, c, h) {
		...
		(function(a) {
			var b;
			if(!a.fixed)
				for(b = 0; b < m.length; b++) t(x.start, m[b].children(), C, {
					b: [m[b]]
				});
			a.s && t(x.start, r, A, {
				b: m
			});
			a.extend && (s.addClass(k[16]), a.s && t(x.start, s, B, {
				b: m
			}));
			a.v && (b = r.find("." + k[7]).addClass(k[10]),
				a.fixed && (b = b.add(r.children().not(b).children())), t(x.start, b, C, {
					b: m
				}))
		})(c.n);
		d.vSet = function() {
