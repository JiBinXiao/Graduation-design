                    ...
                    <tbody>
                	  ...
                	  <tr>
                        <td>名称</td>
                     	 <td>  
                     	     <c:choose>
                     	 	<c:when test="${supplier.sname eq '-1'}"></c:when>
                     	 	<c:otherwise>${supplier.sname}</c:otherwise>
                     	 	</c:choose>
                     	 </td>
                  	  </tr>
                  	  <tr>
                        ...
                        <td>   
                        	<c:choose>
                     	 	<c:when test="${supplier.address eq '-1'}"></c:when>
                     	 	<c:otherwise>${supplier.address}</c:otherwise>
                     	 	</c:choose>
                     	 </td>
                  	  </tr>
                  	    <tr>
                       <td>联系电话</td>
                         ...
                         <td>   
                        	<c:choose>
                     	 	<c:when test="${supplier.phone eq '-1'}"></c:when>
                     	 	<c:otherwise>${supplier.phone}</c:otherwise>
                     	 	</c:choose>
                     	 </td>
                  	  </tr>
                  	   <tr>
                        <td>描述</td>
                         ...
                         <td>   
                        	<c:choose>
                     	 	<c:when test="${supplier.sdec eq '-1'}"></c:when>
                     	 	<c:otherwise>${supplier.sdec}</c:otherwise>
                     	 	</c:choose>
                     	 </td>
                  	  </tr>
