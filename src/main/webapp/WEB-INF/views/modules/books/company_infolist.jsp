                        ...
                        <c:forEach items="${page.list}" var="info" varStatus="vs">
                            <tr>
                                ...
                                <td>
                                   ...
                                   <a class="btn btn-xs btn-success btn-outline" href="${ctx}/company_info/gotoupdate?custId=${info.custId}" ><i class="fa fa-edit"></i> 修改</a>
                                   <a class="btn btn-xs btn-success btn-outline" href="${ctx}/company_info/delete?custId=${info.custId}" onclick="return confirm('确定删除当前数据?');"><i class="fa fa-edit"></i> 删除</a>
                                </td>
                            </tr>
                        </c:forEach>
                    </tbody>
