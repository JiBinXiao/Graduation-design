...
<div class="wrapper wrapper-content">
    <div class="row">
        <div class="col-xs-12">
            <blockquote class="text-primary gray-bg-high"><i class="fa fa-codepen text-primary"></i> 层次分析列表
                <form id="searchForm" action="${ctx}/entropy/list" method="post" class="form-inline m-t-sm">
                    ...
                    <a class="btn btn-sm btn-warning  m-l-sm pull-right" href="${ctx}/ahp/form"><i class="fa fa-plus"></i> 新增</a>
            ...
            if (v == "ok"){
                $.ajax({
                    ...
                    success:function(data){
                        if(data.success){
                            top.$.jBox.success("层次分析删除成功！！", "系统提示");
